...
class DMAQ_qattenLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        #self.optimiser = RMSprop([{'params':self.params},{'params':list(self.mixer.attention_weight.parameters()), 'lr':args.lr},
        #                          {'params':list(self.mixer.si_weight.parameters()), 'lr':args.lr},{'params':list(self.mixer.cov.parameters()), 'lr':0.0001}], alpha=args.optim_alpha, eps=args.optim_eps)


        #self.optimiser = RMSprop([{'params':self.params},{'params':list(self.mixer.parameters())}], lr=args.lr, alpha=args.optim_alpha, eps=args.optim_eps)
